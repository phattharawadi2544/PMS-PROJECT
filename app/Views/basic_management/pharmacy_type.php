            ...
            <div class="col-lg-12">
                ...
                <table class="data-tables table mb-0 tbl-server-info">
                    ...
                    <tbody class="ligth-body">
                        ...
                        var_dump($pharmacies_type_list);
                        $count = 0;
                        foreach($pharmacies_type_list as $pharmacies_type):$count++; ?>
                        <tr>
                            <td>
                            ...
                            <td><?php echo  $pharmacies_type["id_pharmacy_type"];?></td>
                            <td><?php echo  $pharmacies_type["pharmacy_type_name"];?></td>
