                                    ...
                                    <center>
                                        <div class="d-flex align-items-center list-action">
                                            <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top"
                                                ...
                                                onclick="edit_data('<?php echo $recive_row["recive_type_id"]; ?>')"><i
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3" id="form_recive_type" method="post"
                        action="<?php echo site_url('recive_type_id'); ?>">
                        <div class="col-md-3">
                            <label for="edit_recive_type_id" class="form-label">รหัสประเภทการรับ</label>
                            <input type="text" class="form-control was-validated" id="edit_recive_type_id"
                                name="recive_type_id" onchange="clr_border(this);">
                        </div>
                        <div class="col-md-9">
                            <label for="edit_recive_type_name" class="form-label">ชื่อประเภทการรับ</label>
                            <input type="text" class="form-control was-validated" id="edit_recive_type_name"
                                name="recive_type_name" onchange="clr_border(this);">
                        </div>
                        <div class="col-md-6">
                            <label for="edit_recive_detail" class="form-label">รายละเอียด</label>
                            <textarea type="text" class="form-control was-validated" id="edit_recive_detail"
                                name="pharmacy_recive_detail" onchange="clr_border(this);"></textarea>
                        </div>
                    </form>
                </div>
