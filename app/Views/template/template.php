      ...
      <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="<?php echo site_url('/');?>" class="header-logo">
                  <img src="<?php echo base_url();?>/assets/images/logo.png" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3">POSDash</h5>
              </a>
          ...
          <div class="data-scrollbar" data-scroll="1">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      <li class="active">
                          <a href="<?php echo base_url();?>/backend/index.html" class="svg-icon">                        
                      ...
                      <li class=" ">
                          ...
                          <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="<?php echo base_url();?>/backend/page-list-product.html">
                                      <i class="las la-minus"></i><span>การจัดการข้อมูลผู้ใช้งาน</span>
                                  </a>
                              </li>
                              <li class="">
                                  <a href="<?php echo base_url();?>/backend/page-add-product.html">
                                      <i class="las la-minus"></i><span>การจัดการข้อมูลยา</span>
                                  </a>
                              </li>
                          </ul>
                      </li>
                      <li class=" ">
                          ...
                          <ul id="category" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                          <a href="<?php echo base_url();?>/backend/page-list-category.html">
                                              <i class="las la-minus"></i><span>รายการยา</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="<?php echo base_url();?>/backend/page-add-category.html">
                                              <i class="las la-minus"></i><span>เพิ่มรายการยา</span>
                                          </a>
                                  </li>
                          </ul>
                      </li>
                      <li class=" ">
                          ...
                          <ul id="sale" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                          <a href="<?php echo base_url();?>/backend/page-list-sale.html">
                                              <i class="las la-minus"></i><span>List Sale</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="<?php echo base_url();?>/backend/page-add-sale.html">
